...
export function RiskScoreDial({ score }) {
  ...
  return (
    <div className="flex items-center gap-5 rounded-2xl bg-gradient-to-br from-white to-[#FCFAF6] p-2">
      <svg width="140" height="140" viewBox="0 0 140 140">
        ...
        <text x="70" y="66" textAnchor="middle" fontSize="28" fontWeight="800" fill="#0F1E2E">{score}</text>
